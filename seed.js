...
db.get("SELECT name FROM sqlite_master WHERE type='table' AND name='Suggestion'", (error, table) => {
  if (error) {
  ...
  if (table) {
    db.serialize(function() {
      db.run("INSERT INTO Suggestion (userId, name, date_of_birth, biography) VALUES ('Stan Lee', 'December 28, 1922', 'I definitely work here')");
